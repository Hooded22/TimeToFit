...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark col-12 mx-auto px-0">
            ...
            <div class = "collapse navbar-collapse col-sm-12 col-10 px-0 mx-auto pb-4 pb-lg-0" id="navigation">
                <ul class = "navbar-nav px-0 col-10 mx-auto">
                    ...
                    <li class = "nav-item col-7 col-xl-1 col-lg-2 mx-auto">
                        <a class = "nav-link col-12" href="comingSoon.php" name = "Contact">
                    ...
                    <li class = "nav-item col-7 col-xl-1 col-lg-2 mx-auto">
                        <a class = "active nav-link col-12" href="../Handlers/logout.php">
                            <!--<i class="fas fa-list d-inline-block d-lg-none mx-4"></i>-->
                            LogOut
                        </a>
                    </li>
      ...
      <div class="container">
        <div class="row">
          <div class="formWrapper col-10 col-lg-6 mx-lg-auto mx-auto my-5 py-2">
            <div class="row">
              <h3 class="col-9 mx-auto pb-2">Confirm Your email</h3>

              <p class = "col-9 mx-auto py-3 d-block" style = "text-align: center;">We just have sended to your email code for confirm email. put this code below and enjoy !</p>

              <form method="POST" action="" class="col-10 mx-auto my-1" id="form-login">
                
                <figure class = "col-8 col-md-6 mx-auto">                
                  <input type="text" name="confirmCode" id = "confirmCode" placeholder="Code" class="mt-0 mb-2 col-12 d-block py-2 mb-3">
                  <figcaption></figcaption>
                </figure>

                
                <button type="button" onclick = "confirmEmail()" name='login' class="mx-auto d-block col-6 col-lg-3 py-1">Confirm</button>
              </form>
            </div>
          </div>
        </div>
...
<script src = "../../Js/Pages/confirmEmail.js"></script>
