...
<div class="container-fluid col-12 mx-auto px-0">
<div class="row">
<!--Part for music-->
<div class="music_container mt-3 mt-lg-5 col-12 col-lg-12 px-0 py-0 mx-auto" style="box-shadow: 5px 0px 14px #000; background: radial-gradient(#272626, #000);">

<div class="music_title col-12 col-lg-6 mx-auto px-0">
	<h5 style="text-align: center;" class="mt-2 mb-0">Tytuł piosenki</h5>
</div>
...
<div class="col-12 py-3 py-lg-0 mx-0 px-0 my-0 music_menu_bottom">
